...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        defaults: {
            ...
            onReady: function(a) {console.log(a)},
                                    ...
                                    events: {
                                        onReady: function(a) {
                                            YTPlayer.player = a.target, YTPlayer.isReady || (YTPlayer.isReady = YTPlayer.isPlayer && !YTPlayer.opt.autoPlay ? !1 : !0, YTPlayer.playerEl = YTPlayer.player.getIframe(), jQuery(YTPlayer.playerEl).unselectable(), $YTPlayer.optimizeDisplay(), jQuery(window).off("resize.YTP_" + YTPlayer.id).on("resize.YTP_" + YTPlayer.id, function() {
                                                ...
                                                jQuery.mbCookie.set("YTPlayer_" + YTPlayer.videoID, a, 0)
                                            }), jQuery.mbYTPlayer.checkForState(YTPlayer))
                                            console.log($(".ytp-pause-overlay"));//.contents().find(".ytp-pause-overlay"));
                                            //.contents().find("head")
        ...
        pause: function() {
            var a = this.get(0);
            frames["iframe_" + a.id].contentWindow.postMessage('h2{color:red;}','*');
